...
オブジェクト指向は、クラスを基準としたプログラムを設計する方法の１つです。
...
### 変数と関数の呼び出し  
オブジェクトの変数の呼び出しは、 . を使って 
<font color="red">オブジェクト.変数名</font>で指定します。  
関数の呼び出しは、　 
<font color="red">オブジェクト.変数名（引数）</font>で指定します。  
＊引数については、第3回関数とクラスの会で説明します。
